...
logSummary() {
    echo ""
        ...
        echo "Gateway - http://store.jhipster.34.79.34.217.nip.io"
        echo "Zipkin - http://zipkin.istio-system.34.79.34.217.nip.io"
        echo "Grafana - http://grafana.istio-system.34.79.34.217.nip.io"
        echo "Kiali - http://kiali.istio-system.34.79.34.217.nip.io"
        echo "#####################################################"
}
