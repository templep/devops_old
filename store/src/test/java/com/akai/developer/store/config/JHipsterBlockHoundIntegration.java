...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.akai.developer.store.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.akai.developer.store.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
